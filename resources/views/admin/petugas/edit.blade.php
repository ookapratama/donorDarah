                ...
                <div class="row justify-content-center">
                    <div class="col-10">
                        <div class="card">
                            ...
                            <div class="card-body">
                                {{-- form --}}
                                <form action="{{ route('account_petugas.update') }}" enctype="multipart/form-data" method="POST" class="needs-validation" novalidate="">
                                    {{ csrf_field() }}
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="username" class="form-control" required="" value="{{ $dt->username }}"/>
                                                    <div class="invalid-feedback">
                                                        Masukkan Username
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group col-md">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="password" name="password" class="form-control" required="" value="{{ $dt->password }}" />
                                                    <div class="invalid-feedback">
                                                        Masukkan Password
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="alamat" class="form-control" required="" value="{{ $dt->alamat }}" />
                                                    <div class="invalid-feedback">
                                                        Masukkan Alamat
                                                    </div>
                                                </div>
